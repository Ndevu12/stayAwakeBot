...
Audit the machine: credential exposure, editor settings for every editor of the VS Code family installed here, what a coding agent may run without asking, the start-up surface, and optionally a
