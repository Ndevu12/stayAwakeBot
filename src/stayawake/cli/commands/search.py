...
_INDEX = [
    ...
    ("saw fix", "prepare a cleanup branch per infected repo; --pr to open a PR; on confirmed infection also removes the installed tree; amend replaces past commits that still carry the payload",
     "fix remediate clean repair remove branch pr pull request open publish remote local sweep installed tree amend history"),
