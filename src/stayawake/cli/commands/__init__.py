...
from . import (audit, auth, completion, db, discard, doctor, fix, guard, harden, hook, intro,
               scan, search, watch)

REGISTRARS = [scan, fix, discard, audit, harden, watch, guard, hook, auth, search, intro, db, doctor,
              completion]
