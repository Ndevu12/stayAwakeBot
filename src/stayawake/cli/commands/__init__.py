...
from . import audit, auth, completion, db, discard, doctor, fix, guard, harden, hook, intro, scan, search

REGISTRARS = [scan, fix, discard, audit, harden, guard, hook, auth, search, intro, db, doctor, completion]
