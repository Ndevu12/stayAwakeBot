...
from stayawake.utils.invocation import (POSIX_SHELLS, resolve_invocation, _ASSIGNMENT,
                                        _INTERPRETERS, _SHELL_C_FLAG, _SYSTEM_BIN_DIRS,
                                        _WRAPPER_VALUE_OPTS, _program_index, _program_name)
