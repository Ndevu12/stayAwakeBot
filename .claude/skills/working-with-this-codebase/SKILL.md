...
honestly reject non-fitting ideas rather than force them. (Adversarial *refuters* are the opposite and
deliberate — see `security-change-discipline`; don't conflate the two.)

Related: `engineering-standard`, `shipping-changes`, `security-change-discipline`.
